package server.wal.config.swagger;
...
public class SwaggerConfig {
    ...
    private static final String API_NAME = "WAL Project API";
    private static final String API_VERSION = "0.0.1";
    private static final String API_DESCRIPTION = "인증 토큰이 필요한 API는 오른쪽에 [Authorize] 자물쇠를 클릭해서 토큰을 넣어두면 쉽게 테스트할 수 있습니다";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("CHO CHAN WOO", "https://www.instagram.com/breakfast_wu", "chocw0402@gmail.com"))
                .build();
    }
